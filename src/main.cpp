...
public:
    ...
    [[nodiscard]] VkFormat findSupportedFormat (const std::vector<VkFormat>& candidates, const VkImageTiling tiling,
    ...
    void generateMipmaps (const VkImage image, const VkFormat imageFormat, const int32_t texWidth,
    ...
    void transitionImageLayout (const VkImage image, VkFormat format, const VkImageLayout oldLayout,
    ...
    static std::vector<char> readFile (const std::string& filename)
    {
        ...
        file.seekg(0);
        file.read(buffer.data(), fileSize); // NOLINT(*-narrowing-conversions)
